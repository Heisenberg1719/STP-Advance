...
if __name__ == '__main__':
    ...
    except KeyboardInterrupt:logger.info("Server shutdown initiated by user (KeyboardInterrupt).")
    except Exception as e:logger.error(f"An error occurred while starting the server: {e}", exc_info=True)
